...
class AutoClickService:
    ...
    def __init__(self, config_manager) -> None:
        ...
        # Lock protecting _is_auto_clicking to avoid race between monitor and listener threads.
        self._auto_clicking_lock: threading.Lock = threading.Lock()
